...
sequences = list(zip(protein, secondstr))
...
#    modeltest.forward(sequence)
    print('########################loop number ' )
    print(sequence)
    print(modeltest.decode(sequence))    #alpha, secstru expected, viterbi 
    result.append(modeltest.decode(sequence)) 
    forw= modeltest.forward(sequence)
    #print('this is forward : ', forw, len(forw))
    testforw.append(forw)
    print('forward', forw)
    backw = modeltest.backward(sequence)
    print('backward', backw)
    testbackw.append(backw)
